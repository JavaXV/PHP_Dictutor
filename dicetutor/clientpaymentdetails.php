      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
              <input type="date" class="form-control" name="search1" placeholder="First-Name"  style="height:50px;  width:240px;" >
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Transaction Payment Table</h1>
			<br>
		      <b style="color:#0033FF;">Note: Please click search button by in-putting the date to search!!!</b>
...
$sql = "SELECT * FROM transaction WHERE datepaid ='$search1'";
