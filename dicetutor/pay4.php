...
<div class="wrapper">
  ...
  <!-- /.navbar -->
					...
					$sql = "SELECT id, radNo, reference, amount,  balance, email FROM transaction WHERE email = '$email' ";
      ...
      <nav class="mt-2" style="position:fixed;">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="position:fixed;">
          <!-- Add icons to the links using the .nav-icon class
			   ...
			   <b style="color:#FFFFFF; position:absolute; left:20px; font-size:20px; font-family:'Courier New', Courier, monospace;">Amount: <?php echo $amount . "NGN" ; ?></b>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
		   ...
		   if(isset($_SESSION['email']))
		   {
		     echo $_SESSION['email']. " Ref: " . "[". $reference. "]";
		   }
		...
		<div class="row">
			<div class="col-12">
				<div class="block">
					...
					<div class="image align-self-center"><img src="images/Payment-Method1.jpg" width="700px" height="500px" alt="desk-image">
		   ...
		   ?>" required maxlength="40" id="email-address" style="height:40px;" class="form-control" size="130" placeholder=""  >
						  </div>
						  
						  <div class="form-group">
					<select name="email" id="amount" style="height:40px;" class="form-control" required="true" style="height:45px;">
                       <option value="<?php echo $amount ; ?>"><?php  echo $amount ; ?></option>
						  ...
						  <div class="form-submit">
							<!-- Submit Button -->			
						   <button type="submit" onClick="payWithPaystack()" class="btn btn-outline-info" style="width:200px; height:60px;">Complete-Payment</button>
						  </div>
						</form>
