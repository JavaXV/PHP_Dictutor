...
<?php  include_once("serviceConfirm.php");?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
 ...
 <center>      
	...
	<div class="form-group"  >
      ...
      <div class="form-group"  >
		  ...
		  <button type="submit" name="Add" class="btn btn-outline-info" style="right:20px; height:100px; top:110px; position:absolute;">Confirm Service</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
