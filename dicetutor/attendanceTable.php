  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Attendance and Approve Contract Extension Table</h1>
			<br>
		      <b style="color:#0033FF; font-size:16px;">Note: Please click search button by in-putting the date to search!!!</b>
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:256px; width:1257px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
                echo "<th>Clientname</th>";
                echo "<th>Tutor.Name</th>";
				echo "<th>No.Of.Days<br>[Present]</th>";
				echo "<th>Confirm.Attendance<br>Status</th>";
				echo "<th>Start.Time</th>";
				echo "<th>End.Time</th>";
			    echo "<th>Salary</th>";
				echo "<th>Interest</th>";
				echo "<th>Date</th>";
				echo "<th>Contract Status</th>";
				echo "<th>Stop<br>Attendance</th>";	
				echo "<th>Approve.Contract<br>Extension</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
                ...
                echo  "<td>" . "<input type='submit' name='pause' value='PAUSE' style='color:blue;'>" . "</td>";
				echo  "</form>";
                ...
                echo  "<td>" . "<input type='submit' name='aprrovedext' value='APPROVED' style='color:blue;'>" . "</td>";
				echo  "</form>";
