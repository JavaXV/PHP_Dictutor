        ...
        <div class="input-group" data-widget="sidebar-search">
           <form action="RegisterView.php" method="POST">
            <div>
			   ...
			   <select class="form-control" style="height:50px;  width:240px; border-color:#0000FF;" name="search1">
						<option value="Select Option">Select Option</option>
						<option value="Checked">Checked</option>
						<option value="Un-Checked">Un-Checked</option>
				   </select>
				   <select class="form-control"  style="height:50px;  width:240px; border-color:#0000FF;" name="search2">
              ...
              <li class="nav-item">
                <a href="adminTicket.php" class="nav-link active" style="color:#FFFF00;">Close Ticket</a>
				<a href="disputeMessage.php" class="nav-link active" style="color:#FFFF00;">Back</a>
              </li>
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1250px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
                echo "<th>Name</th>";
                echo "<th>Email Address</th>";
                echo "<th>Message</th>";
				echo "<th>Ticket<br>Option</th>";
                echo "<th>Ticket.Email</th>";
                echo "<th>Date</th>";
				echo "<th>Ticket<br>Status</th>";
				echo "<th>Mail</th>";
				echo "<th>Dispute<br>Approve</th>";
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<tr>";
                ...
                echo "<td>" . $row['mails'] . "</td>";
                echo "<td>" . $row['date'] . "</td>";
				echo "<td>" . $row['status'] . "</td>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='radNo' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submit' value='Sent-Mail' style='color:blue;'>" . "</td>";
				echo  "</form>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='tick' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submitTicket' value='Resolved' style='color:blue;'>" . "</td>";
				echo  "</form>";
