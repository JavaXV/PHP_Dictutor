            ...
            <div>
              <input type="text" class="form-control" name="search1" placeholder="First-Name" >
                <input type="submit" class="form-control" name="searchRequest" value="Search" style="background-color:#0033FF; color:#FFFFFF;">
				 <input type="submit" class="form-control" name="delete" value="Delete" style="background-color:#0033FF; color:#FFFFFF;">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tutors Bio-Data</h1>
			<br>
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:70px; width:1200px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
                echo "<th style='color:#0000FF;'>FIRSTNAME</th>";
                echo "<th style='color:#0000FF;'>LASTNAME</th>";
				echo "<th style='color:#0000FF;'>EMAIL-ADDRESS</th>";
				echo "<th style='color:#0000FF;'>GENDER</th>";
                echo "<th style='color:#0000FF;'>DATE-BIRTH</th>";
                echo "<th style='color:#0000FF;'>PHONE-NO</th>";
				echo "<th style='color:#0000FF;'>HOME-ADDRESS</th>";
				echo "<th style='color:#0000FF;'>VICINITY</th>";
				echo "<th style='color:#0000FF;'>STATE-ORIGIN</th>";
                echo "<th style='color:#0000FF;'>RESIDENT-STATE</th>";
				echo "<th style='color:#0000FF;'>TUTOR-DETAILS</th>";
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td>" . $row['dob_day'] . "</td>";
                echo "<td>" . $row['number1'] . "<br>".  $row['number2'] ."</td>";
                echo "<td>" . $row['address'] . "</td>";
                echo "<td>" . $row['vicinity'] . "</td>";
				echo "<td>" . $row['state'] . "</td>";
                echo "<td>" . $row['residentstate'] . "</td>";	
                echo "<td>" . $row['tutor_description'] . "</td>";
