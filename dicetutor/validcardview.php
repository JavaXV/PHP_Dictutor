        ...
        <div class="input-group" data-widget="sidebar-search">
           <form action="registertable.php" method="POST">
            <div>
              ...
              <li class="nav-item">
                <a href="admincheck.php" class="nav-link active">
                  <p>Back</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View Validation Card</h1>
			<br>
...
$sql = "SELECT * FROM editprofile WHERE id = '".$search."' ";
    ...
    if(mysqli_num_rows($result) > 0){
         echo "<table>";
           echo "<tr>"; 
			...
			echo "<tr style='position:absolute; left:500px; top:120px;'>";
			echo "<td>" . $row['nin'] . "</td>";	
            echo "</tr>";
			echo "<tr style='position:absolute; left:500px; top:150px;'>";
			echo "<td><img height='500' width='700' src='picture/".$row['image1']."'></td>";
			echo "<br>";	
            echo "</tr>";
			
			echo "<tr style='position:absolute; left:500px; top:670px;'>";
			echo "<td>" . $row['idcard'] ."</td>";	
            echo "</tr>";
			echo "<tr style='position:absolute; left:500px; top:690px;'>";
			echo "<td><img height='500' width='700' src='picture/".$row['image2']."'></td>";
            echo "</tr>";
