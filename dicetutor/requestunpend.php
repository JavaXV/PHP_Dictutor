...
<div class="wrapper">
 ...
 <li class="nav-item">
				 ...
				 <a href="serviceRequest.php" class="nav-link active" style="color:#FFFFFF;">
                  BACK
                </a>
              </li>
      <!-- Sidebar Menu -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Decline Request</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <center>      
    ...
    <div class="row row-space-4"  align="center">
      <div class="form-group"  >
                 ...
                 <div class="form-group">
                    <input type="text" class="form-control" value="" name="code"  placeholder=' Request.ID '">
                  </div>
             </div>
			  <div class="form-group"  >
		  ...
		  <button type="submit" name="nameValue1" class="btn btn-outline-info" style="right:20px; height:100px; top:110px; position:absolute;">Request Decline</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
