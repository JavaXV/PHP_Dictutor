  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Confirm Tutor Present</h1>
...
?>
    ...
    <div class="row" >
        ...
        <form  action="attendanceview1.php"  method="POST" >
          ...
          <div class="panel-body"  align="center">
                       ...
                       <br><br><br>
					<hr> <b style="color:#0000FF;">Confirm Attendance</b><hr> 
    <div class="row row-space-4"  align="center">
       ...
       <input type="text" name="search" required maxlength="140"  style="height:60px; width:600px;" value="" class="form-control" size="30" placeholder="Enter Tutor PhoneNo">
           <br>
        </div>
    </div>
         
		  <button type="submit" name="searchRequest" class="btn btn-outline-info" style="right:100px; height:100px; top:120px; position:absolute;">Confirm Attendance</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
