...
<?php include_once("tutorpayment.php");?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Transaction Table</h1>
			<br>
 ...
 <form action="" method="POST">
            <div>
 <input type="submit" class="form-control" name="payment" value="Tutor Payment" style="background-color:#0033FF; left:350px; position:absolute; height:200px; width:400px; color:#FFFFFF;">
 
  <input type="submit" class="form-control" name="payment1" value="Delete Payment Table" style="background-color:#0033FF; left:850px; position:absolute; height:200px; width:400px; color:#FFFFFF;">
