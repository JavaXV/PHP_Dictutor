...
<body>
<img src="images/dices.jpg" height="1150" width="100%">
      ...
      <div class="from">
		...
		<div class="from-list" style="color:#0033CC;">
		 <label>Email Address</label>
             <input type="text" name="email" placeholder="" style="color:#990099;" required Height="35px" Width="329px">           
        </div>
	
	   	<div class="from-list" style="color:#0033CC;">
		 <label>Sign-up As</label>
         <select class="form-select form-select-lg mb-6" name="user" style="width:338px; height:40px; background-color:#FFFFFF; color:#990099; font-size:17px; color:#666666;">
		...
		<label>Password</label>
           <input type="text" name="password1" placeholder="" style="color:#990099;" required Height="35px" Width="329px">                       
        </div>
		<div class="from-list">
		<label>Confirmed Password</label>
           <input type="text" name="password2" placeholder="" style="color:#990099;" required Height="35px" Width="329px">                       
        </div>
       
        <p class="error-message">&nbsp;</p>
        <div class="submit-btn" align="center" style="background-color:Red;">
		  <button type="submit" name="submit" class="btn btn-outline-info">Create Account</button> 
        </div>
        <br>
