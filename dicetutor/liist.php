  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Find Out About Tutor To Make a Request...</h1>
			<br><br>
...
if (isset($_POST['requestUpdate']))
   {   
		$location =$_POST['search1'];
		$subject =$_POST['subject'];
 
// Attempt select query execution
$sql = "SELECT * FROM serviceadd WHERE city = '".$location."' AND reference1='".$subject."' ";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1290px;  height:50px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
				 ...
				 echo "<th>Tutor Request.ID</th>";
				 echo "<th>Price/Hrs</th>";
				 echo "<th>Make.Request</th>";
				 echo "<th>Image</th>";
...
echo "<td><button name='search' class='form-group' align='center' style='background-color:blue; color:white;'>Request</button></td>";
...
?>
 <?php
		    ...
		    echo "<b style='font-size:17px; color:#CC3300; position:absolute; top:130px;'>" . "Subject:  ".   $subject ."</b>" ."<br>";		    
		    echo "<b style='font-size:17px; color:#CC3300; position:absolute; top:150px;'>" . "Location:  ".  $city ."</b>" ;
