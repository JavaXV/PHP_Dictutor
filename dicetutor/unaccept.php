           ...
           <form action="" method="POST">
            <div>
			   <select class="form-control" style="height:50px;  width:240px; border-color:#0000FF;" name="search1">
						...
						<option value="Accept Request">Request Accepted</option>
				   </select>
              ...
              <li class="nav-item">
				 <a href="AdminDashboard.php" class="nav-link active" style="color:#FFFFFF;">
                  BACK
                </a>
              </li>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
           <div class="col-sm-6">
			...
			<br>
		      <b style="color:#0033FF;">Note: Please click search button to check if Request was NOT-Accepted!!!</b>
          </div><!-- /.col -->
...
$sql = "SELECT * FROM serviceadd WHERE requestaccept = '".$search."'";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
                ...
                echo  "<td>" . "<input type='submit' name='delete' value='Return.To.Pending' style='color:blue;'>" . "</td>";
				echo  "</form>";
