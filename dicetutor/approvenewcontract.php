  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Approve New Contract for Attendance...</h1>
			<br><br>
...
if (isset($_POST['submitd']))
   {   		
			...
			$query=("UPDATE attendances SET contract='".$active."' WHERE id='".$id."' ");
			$result = mysqli_query($conn,$query);
			  if($result)
				  {
				  
				  echo "<script>alert( 'New Contract Approved!!!');</script>";		
				  }
				  else
				  {
   ...
   {   		
			...
			$result = mysqli_query($conn,$query);
			  if($result)
				  ...
				  echo "<script>alert( 'New Contract Not Approved!!!');</script>";		
				  }
				  else
				  {
					// header("Location: uploadphoto.php");
...
$sql = "SELECT * FROM attendances WHERE contract = '$email' ";
    ...
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1270px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
				...
				echo "<th>Date</th>";
				echo "<th>Status</th>";
			    echo "<th>Approve.Contract</th>";
				echo "<th>Declined.Contract</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
				...
				echo "<td><button name='submitd' class='form-group' align='center' style='background-color:blue; color:white;'>Approved</button></td>";
				echo  "</form>";
				
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='Nos' value='$id'>";
				echo "<td><button name='submity' class='form-group' align='center' style='background-color:blue; color:white;'>Declined</button></td>";
				echo  "</form>";
