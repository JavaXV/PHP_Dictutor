...
?>
      ...
      <?php
					...
					if($count1>0)
					 ...
					 $sql = "SELECT * FROM serviceadd WHERE code='".$code."' AND duration2='".$dates."'";
					 $result = mysqli_query($conn, $sql);
					  ...
					  while($row = mysqli_fetch_assoc($result)) {
						   ...
						   $actives = "Expired";
								   ...
								   if($duration2 == $date)
								   {
										 ...
										 $sql = "UPDATE attendances SET contract='$actives' WHERE code='$code'";
		  ...
		  <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p>
			   ...
			   <ul class="nav nav-treeview">
			    <li class="nav-item">
                <a href="deliveredservice.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#FFFF00;">Add Service</p>
                </a>
              </li>	 
			  <li class="nav-item">
                <a href="serviceRequest.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#FFFF00;">Service Request </p>
                </a>
              </li>
			     <li class="nav-item">
                <a href="attendance.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#FFFF00;">Add Attendance</p>
                </a>
              </li>
			    <li class="nav-item">
                <a href="disputes.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#FFFF00;">Ticketting Msg</p>
                </a>
              </li>
			     <li class="nav-item">
                <a href="attendview.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#FFFF00;">View Attendance</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p style="color:#FFFF00;">Delivered Service</p>
                </a>
              </li>
