    ...
    <div class="sidebar">
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="EditProfileSearch.php" method="POST">
            <div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tutors Education Qualification</h1>
			<br>
...
$sql = "SELECT * FROM editprofile  WHERE AdminApprove = '".$search."'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:70px; width:100%;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
           
                echo "<th style='color:#0000FF;'>FIRSTNAME</th>";
                echo "<th style='color:#0000FF;'>SCHOOL</th>";
				echo "<th style='color:#0000FF;'>COURSE</th>";
                echo "<th style='color:#0000FF;'>DEGREE</th>";
                echo "<th style='color:#0000FF;'>TEACHING</th>";
				echo "<th style='color:#0000FF;'>PREVIOUS-WORK</th>";
				echo "<th style='color:#0000FF;'>ROLE</th>";
				
				echo "<th style='color:#0000FF;'>CURRICULUM</th>";
				echo "<th style='color:#0000FF;'>OTHER SCHOOL</th>";
                echo "<th style='color:#0000FF;'>OTHER COURSE</th>";
				echo "<th style='color:#0000FF;'>OTHER DEGREE</th>";
				echo "<th style='color:#0000FF;'>CHECK</th>";
				echo "<th style='color:#0000FF;'>STATUS</th>";
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<tr>";
				...
				echo "<td>" . $row['curriculum_used'] . "</td>";
			    echo "<td>" . $row['school1'] . "</td>";
                echo "<td>" . $row['course1'] . "</td>";
				echo "<td>" . $row['degree1'] . "</td>";
				echo "<td>" . $row['AdminApprove'] . "</td>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='id' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submit' value='Approved' style='color:blue;'>" . "</td>";
				echo  "</form>";
