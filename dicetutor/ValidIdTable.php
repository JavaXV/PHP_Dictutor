...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:70px; width:100%; padding-left:60px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
                echo "<th>FULLNAME</th>";
                echo "<th>ACCOUNT-NO</th>";
                echo "<th>BANK-CODE</th>";
				echo "<th>NATIONAL-IDENTITY-NO</th>";
                echo "<th>OTHER-ID</th>";
