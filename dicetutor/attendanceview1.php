		  ...
		  <?php
		   ...
		   ?></a>
			 ...
			 <?php
					...
					$sql = "SELECT id, Email FROM teacherregister WHERE Email = '$email' ";
            ...
            ?>
			   <?php
					...
					$sql = "SELECT id, FirstName, LastName, Email, VerifyNo FROM teacherregister WHERE Email = '$email' ";
					$result = mysqli_query($conn, $sql);
       ...
       <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
                   <input type="text" name="search" value="" class="form-control" placeholder="Enter Tutor-PhoneNo" style="height:60px; width:240px;">
                   <input type="submit" class="form-control"  name="searchRequest" value="Search" style="color:#FFFFFF; background-color:#0033FF;">
              </div>
            </div>
          </form>
              <li class="nav-item">
...
// Attempt select query execution
$sql = "SELECT * FROM attendances WHERE tutorphoneno = '$email' ";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1270px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
                echo "<th>Tutorname</th>";
                echo "<th>Attendance<br>Status</th>";
				echo "<th>No.Of.Days<br>[Present]</th>";
				echo "<th>Confirm<br>Attendance<br>Status</th>";
				echo "<th>Start.Time</th>";
				echo "<th>End.Time</th>";
				echo "<th>Salary</th>";
				echo "<th>Date</th>";
			    echo "<th>Decline<br>Attendance</th>";
				echo "<th>Decline<br>Attendance +<br>Minus Money</th>";
				echo "<th>Accept<br>Attendance</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
				...
				echo  "<input type='hidden' name='Nos' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submitss1' value='Mark-Absent' style='color:blue;'>" . "</td>";
				echo  "</form>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='Nos' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submitss' value='Mark-Absent' style='color:blue;'>" . "</td>";
				echo  "</form>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='radNo' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submit' value='Mark-Present' style='color:blue;'>" . "</td>";
				echo  "</form>";
        ...
        echo "No records matching your request were found.". $sql;
...
// Attempt select query execution
$sql = "SELECT * FROM attendances  WHERE clientemail = '".$email."' ";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table>";
           echo "<tr>"; 
