...
<?php include_once("updateCode.php");?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Account Confirmation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              
              <li class="breadcrumb-item active" style="font-size:18px; font-family:Verdana, Arial, Helvetica, sans-serif;"><?php
		   if(isset($_SESSION['name']))
		   {
		     echo $_SESSION['name']. "[Tutor]";
		   }
 ...
 <center>      
    ...
    <div class="row  row-space-4">
        ...
        <div class="col-md-6 col-sm-6 space-for-mobile">
            <input type="text" name="email" maxlength="40" class="form-control" size="130"  placeholder="Enter Email e.g Sm@gmail.com" required="" >
           <br>
        </div>
    </div>
	<div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">Verification Code</label>

        <div class="col-md-6 col-sm-6 space-for-mobile">
            <input type="text" name="code" maxlength="40" class="form-control" size="130" placeholder="Verify Code e.g 0421" required="" >
           <br>
        </div>
		<br>
		  <button type="submit" name="accountConfirmed" class="btn btn-outline-info" style="left:600px; height:100px; top:350px; position:absolute;">ConFirmed Account</button>
		  <br><br><br><br><br>
    </div>
	</div></div>
	</form>
