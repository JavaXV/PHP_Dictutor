...
?>
		 ...
		 <?php
            ...
            ?> </a>
			 ...
			 <?php
					...
					$sql = "SELECT id, code, monthyear, tutoremail FROM attendanceview WHERE tutoremail = '$email' ";
					$result = mysqli_query($conn, $sql);
      ...
      <!-- SidebarSearch Form -->
       <div class="form-inline">
		<a href=""style="color:white;  font-size:16px;">Id/Month/Year</a>
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
			  <input type="text" name="monthyear" value="<?php echo $mntyear; ?>" class="form-control" placeholder="Id/Mth/Year Eg :098789/12/2021" style="height:60px; width:250px;">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
           <div class="col-sm-6">
			...
			<br>
		      <b style="color:#0033FF;">Note: Please click search button to view attendance!!!</b>
          </div><!-- /.col -->
...
// Attempt select query execution
$sql = "SELECT * FROM attendanceview WHERE code = '".$code."' AND monthyear = '".$monthyear."'  ";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1280px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
				...
				echo "<th>Date</th>";
				echo "<th>Lesson.Start.Time</th>";
				
				echo "<th>Confirm.Attendance-Status</th>";
				echo "<th>Id/Month/Year</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
				...
				echo "<td>" . $row['date'] . "</td>";  
				echo "<td>" . $row['lessonstarttime'] . "</td>"; 
