		  ...
		  <?php
		   ...
		   ?> </a>
			 ...
			 <?php
					...
					$sql = "SELECT id, code, tutoremail, clientemail FROM serviceadd WHERE clientemail = '$email' ";
       ...
       <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
			  <input type="text" name="search1" value="" class="form-control" placeholder="Enter Your PhoneNo" style="width:240px;">
              ...
              <li class="nav-item">
				 <a href="DashboardSchool.php" class="nav-link active" style="color:#FFFFFF;">
                  BACK
                </a>
              </li>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
           <div class="col-sm-6">
			...
			<br>
		      <b style="color:#0033FF;">Note: Please click search button to check if Request was Accepted!!!</b>
          </div><!-- /.col -->
...
// Attempt select query execution
$sql = "SELECT * FROM serviceadd WHERE clientphoneno = '".$search."'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
				...
				echo  "<form action='showViews.php' method='POST'>";
