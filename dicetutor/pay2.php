  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Payment Platform With DiceTutor...</h1>
			<br>
	...
	<div class="container" style="position:absolute; top:150px;">
		<div class="row">
			<div class="col-12">
				<div class="block">
					<!-- Image -->
					<div class="image align-self-center" style="padding-left:10px;"><img src="images/Payment-Method1.jpg" width="700px" height="500px" alt="desk-image">
                        <br />
			    ...
			    <form action="clientcontinuepayment.php" method="post">
				 <!--  <input type="text" name="search1" required maxlength="40" class="form-control" size="130" placeholder="Location: E.g  Surulere"  > -->  
		   ...
		   ?></option>
							...
							<!-- Submit Button -->			
						  <br>
						  <button type="submit" name="searchRequest" class="btn btn-outline-info" style="width:160px; height:60px;">Continue</button>
