...
<?php include_once("verify_transaction.php");?>
		  ...
		  <?php
		   ...
		   ?>
            ...
            ?>
					...
					$sql = "SELECT id, radNo, reference, email FROM transaction WHERE radNo = '$tutorid' ";
					$result = mysqli_query($conn, $sql);
		...
		<div class="row">
						...
						<div class="col-md-10 print-table" style="position:absolute; top:20px;">
                          	<table class="table table-striped table-hover" border="" style="width:500px; color:#0000FF; top:1px; position:absolute;">
								...
								<tbody>
									...
									<td ><p style="color:#0000FF; font-size:23px; font-family:Geneva, Arial, Helvetica, sans-serif;"><?php echo $salary."NGN" ; ?></p></td>
									...
									<td><p style="color:#0000FF; font-size:23px; font-family:Geneva, Arial, Helvetica, sans-serif;"><?php echo $monthly."NGN"  ; ?></p></td>
					...
					<div class="content text-center">
				       ...
				       <div class="form-group">		
				           <input type="hidden" name="name" value="<?php echo $clientname ; ?>" required maxlength="140" class="form-control"  >
				            ...
				            <div class="form-group">		
				            <input type="hidden" name="email" value="<?php echo $email ; ?>" required maxlength="140" class="form-control" >
						  </div>
						    <div class="form-group">		
						    ...
						    <div class="form-group">		
				            <input type="hidden" name="radNo" value="<?php
		   if(isset($_SESSION['tutorid']))
		   {
		     echo $_SESSION['tutorid'];
		   }
		   ...
		   ?>" required maxlength="140"  class="form-control" >
						  ...
						  <div class="form-submit">
							<!-- Submit Button -->			
						   <button type="submit" name="pay" class="btn btn-outline-info" style="width:160px; height:60px;">Make-Payment</button>
						  </div>
						</form>
<br>
<br>
