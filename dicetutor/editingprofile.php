...
<?php include_once("updatescript.php");?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
?>
	...
	<div class="form-inline" align="center">
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
              <input type="text" class="form-control" name="code" placeholder="Unique ID" >
                <input type="submit" class="form-control" name="search" value="Search To Update" style="background-color:#0033FF; color:#FFFFFF;">		 
              </div>
		   </form>
            </div>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	 ...
	 <form action="" method="POST" >
	        <input type="hidden" name="email"  maxlength="40" value="<?php
		   if(isset($_SESSION['email']))
		   {
		     echo $_SESSION['email'];
		   }
		   
		   ?>"  class="form-control" size="130" >
          ...
          <div class="card-body" style="background-color:#E1F0F0;>
			 ...
			 <form action="" method="POST">
			  <div class="form-group"  >
                 ...
                 <div class="form-group">		
					  ...
					  <select class="form-control"  name="code"  style="height:45px;">
		   ...
		   ?>" name="email"  placeholder=''">
			  ...
			  <div class="form-group"  >
                 ...
                 <div class="form-group">
                    <input type="text" class="form-control"  style="height:45px;" value="<?php echo $dob_day ; ?>" name="dob_day"  placeholder='Example : Day/Month/Year'">
                  </div>
             </div>
			 <div class="form-group"  >
                 <label>Gender</label>
                 <div class="form-group">
                    ...
                    <select class="form-control"  name="gender"  style="height:45px;" >
		     ...
		     <div class="form-group">
                 ...
                 <div class="form-group">
                    <input type="text" class="form-control"  style="height:45px;" value="<?php echo $address ; ?>" name="address"  placeholder="E.g 28 Saint John Street Gowon Estate Ipaja"">
                  </div>
             </div>
			 <br>
			   <div class="form-group"  >
                 <label>Tutor Phone Number:</label>
                 <div class="form-group">
                    <input type="text" class="form-control"  style="height:45px;" value="<?php echo $number1 ; ?>" name="number1"  placeholder=''">
                  </div>
             </div>
			 <br>
			 <div class="form-group">
  ...
  <option value="<?php echo $residentstate ; ?>" selected=""><?php echo $residentstate ; ?></option>
  ...
  <option value="Zamfara">Zamfara</option>
            ...
            <div class="form-group">
                <div><label>Town or City</label></div>
				 <select class="form-control" required name="vicinity">
                                     <option value="<?php echo $vicinity ; ?>"><?php echo $vicinity ; ?></option>
            ...
            <div class="form-group">
                <div><label>State</label></div>
                    <select name="state" class="form-control"  style="height:45px;"  placeholder="Input your state" >
...
Enter your highest educational qualifications, whether in-view or completed. Please write in full, no abbreviations. E.g. write 'University of Lagos' not 'UNILAG' </label>
				 ...
				 <div class="form-group">
                    <input type="text" class="form-control"  style="height:45px;"  value="<?php echo $school ; ?>" name="school"  placeholder=''">
                  </div>
             </div>
			   <div class="row row-space-2">
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="course"  style="height:45px;"  value="<?php echo $course ; ?>" maxlength="125" class="form-control">
  ...
  <option value="S.S.C.E">S.S.C.E</option>
				...
				<br>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="workexperience"  style="height:45px;" value="<?php echo $workexperience ; ?>" maxlength="125" class="form-control">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="role" value="<?php echo $role ; ?>" maxlength="125" class="form-control"  style="height:45px;">
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control"  name="workexperience_current_work"  style="height:45px;">
                    <option value="<?php echo $workexperience_current_work ; ?>" selected=""><?php echo $workexperience_current_work ; ?></option>
...
If you teach academic subjects for nursery, primary or secondary, then select the curriculum you can teach with. Skip this if you teach non-academic subjects or skills. </label></b>
                 <div class="form-group">
				    <div class="col-12 col-sm-12">
                    <select class="form-control"  name="curriculum_used"  style="height:45px;">
                    <option value="<?php echo $curriculum_used ; ?>" selected="selected"><?php echo $curriculum_used ; ?></option>
...
Write at least 2-4 paragraphs describing your tutoring and teaching qualifications and experience. Be sure to include any awards or trainings you?ve received that support your teaching credentials.Outline the subjects you specialize in and explain your teaching method. Include any degrees or awards that make you standout and qualified to teach those subjects or skills. Write as though you are talking to the client directly and encourage them to book a lesson with you.
                        ...
                        <textarea class="form-control" name="tutor_description" rows="5" height="120"  placeholder="max 400 word"><?php echo $tutor_description ; ?></textarea>
                      </div>
                </div>
			         <div class="col-sm-12 col-sm-offset-9" align="right">
					  <input type="submit" name="Update"  class="btn btn-primary btn-lg" value="Submit Update">
