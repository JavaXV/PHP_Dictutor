...
?>
       ...
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="DashBoardTeacher.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Upload Valid ID Card</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <center>      
    ...
    <div class="row row-space-4"  align="center">
       ...
       <input type="text" name="name" maxlength="140" value=" <?php echo $firstname ." ". $lastname ; ?>" class="form-control" size="30" placeholder="Enter Name"  required="" >
           <br>
        </div>
    </div>

    <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">Unique.ID</label>

        <div class="col-md-6 col-sm-6 space-for-mobile">
              <select class="form-control" required name="code" >
                    <option selected=<?php echo $code ;?>"><?php echo $code ;?></option>
             </select>
           <br>
        </div>
    </div>
	   <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">National Identity Number</label>

        <div class="col-md-6 col-sm-6 space-for-mobile">
            <input type="text" name="nin" maxlength="40" class="form-control" size="130"  placeholder="NIN e.g 09099998871" required="" >
           <br>
        </div>
    </div>
	<div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">Other Valid Card</label>

        <div class="col-md-6 col-sm-6 space-for-mobile">
            <select class="form-control" required name="idcards" >
	...
	<div style="background-color:#999999; height:100px; width:400px;">
	 <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right" style="color:#CC0000;">NIN</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">    
           <b> <input type="file" name="file">
        </div>
    </div>
	 <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right" style="color:#CC0000;">Others</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">    
		  ...
		  <button type="submit" name="submit1" class="btn btn-outline-info" style="left:1210px; height:100px; top:120px; position:absolute;">Upload ID</button>
		  <br><br><br><br><br>
	</form>
