...
<html class="js" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>@keyframes beginBrowserAutofill{0%{}to{}}@keyframes endBrowserAutofill{0%{}to{}}.pac-container{background-color:#fff;position:absolute!important;z-index:1000;border-radius:2px;border-top:1px solid #d9d9d9;font-family:Arial,sans-serif;box-shadow:0 2px 6px rgba(0,0,0,0.3);-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;overflow:hidden}.pac-logo:after{content:"";padding:1px 1px 1px 0;height:18px;box-sizing:border-box;text-align:right;display:block;background-image:url(https://maps.gstatic.com/mapfiles/api-3/images/powered-by-google-on-white3.png);background-position:right;background-repeat:no-repeat;background-size:120px 14px}.hdpi.pac-logo:after{background-image:url(https://maps.gstatic.com/mapfiles/api-3/images/powered-by-google-on-white3_hdpi.png)}.pac-item{cursor:default;padding:0 4px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;line-height:30px;text-align:left;border-top:1px solid #e6e6e6;font-size:11px;color:#515151}.pac-item:hover{background-color:#fafafa}.pac-item-selected,.pac-item-selected:hover{background-color:#ebf2fe}.pac-matched{font-weight:700}.pac-item-query{font-size:13px;padding-right:3px;color:#000}.pac-icon{width:15px;height:20px;margin-right:7px;margin-top:6px;display:inline-block;vertical-align:top;background-image:url(https://maps.gstatic.com/mapfiles/api-3/images/autocomplete-icons.png);background-size:34px}.hdpi .pac-icon{background-image:url(https://maps.gstatic.com/mapfiles/api-3/images/autocomplete-icons_hdpi.png)}.pac-icon-search{background-position:-1px -1px}.pac-item-selected .pac-icon-search{background-position:-18px -1px}.pac-icon-marker{background-position:-1px -161px}.pac-item-selected .pac-icon-marker{background-position:-18px -161px}.pac-placeholder{color:gray}.pac-target-input:-webkit-autofill{animation-name:beginBrowserAutofill}.pac-target-input:not(:-webkit-autofill){animation-name:endBrowserAutofill}
</style><style>.async-hide { opacity: 0 !important} </style>
    <script type="text/javascript" src="./Profile - Tuteria_files/9431189497"></script><script src="./Profile - Tuteria_files/nr-1212.min.js.download"></script><script async="" src="./Profile - Tuteria_files/main.6ae4a9fc.js.download"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/js"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/insight.min.js.download"></script><script src="./Profile - Tuteria_files/213992805709925" async=""></script><script src="./Profile - Tuteria_files/915522721958382" async=""></script><script async="" src="./Profile - Tuteria_files/fbevents.js.download"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/core.js.download"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/uwt.js.download"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/f.txt"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/insight.min.js.download"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/analytics.js.download"></script><script type="text/javascript" async="" src="./Profile - Tuteria_files/analytics.js.download"></script><script src="./Profile - Tuteria_files/sdk.js.download" async="" crossorigin="anonymous"></script><script id="facebook-jssdk" src="./Profile - Tuteria_files/sdk.js(1).download"></script><script async="" src="./Profile - Tuteria_files/gtm.js.download"></script><script>(function(a,s,y,n,c,h,i,d,e){s.className+=' '+y;h.start=1*new Date;
...
<body id="fouc">
      <form action="editprofile1.php" method="post" >
	        <input type="hidden" name="q" maxlength="140" value="
     <?php
          ...
          <div style="position:absolute; right:37px; top:100px;"><input type="submit"  name="search" class="btn btn-primary btn-lg" value="Edit Profile " height="150"></div>
      </form>
        <div class="outer ">
...
<div class="header-2 hidden-xs">
    ...
    <?php 
	   ...
	   $db = mysqli_select_db($connection, 'dicetutor');
	   
	   if (isset($_POST['search']))
        {
            $name        = $_POST['q'];
			
			$query = "SELECT * FROM editprofile where name = '$name'";
       ...
       <input type="text" name="name" maxlength="140" value="<?php $row['name']?>" class="form-control" size="130" placeholder="Enter Name"  required="" >
           <br>
        </div>
    </div>
    ...
    <div class="row  row-space-4">
        ...
        <div class="col-md-9 col-sm-9 space-for-mobile">
            <input type="text" name="email" maxlength="140" value="<?php $row['email']?>" class="form-control" size="130" placeholder="Enter Email e.g Sm@gmail.com" required="" >
           <br>
        </div>
    </div>

    <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">I am</label>
        <div class="col-md-4 col-sm-4 space-for-mobile">
            <select name="gender" class="form-control input-medium"   required="true" >
  <option value="" selected=""><?php $row['gender']?></option>
        ...
        Phone Number <i class="icon icon-lock icon-pink" data-behavior="tooltip" aria-label="Private"></i>
            ...
            <div class="row">
                <div class="form-group col-md-5 ">
                    <input type="text" name="number1" placeholder="Enter 1st Number" class="form-control" required="" >
               </div>
			    <div class="form-group col-md-5 ">
                    <input type="text" name="number2" placeholder="Enter 2nd Number" class="form-control" required="" >
                </div>
...
<div class="row  row-space-4">
    ...
    <div class="col-md-9 col-sm-9">
        <input type="hidden" name="location_set-TOTAL_FORMS" value="1" id="id_location_set-TOTAL_FORMS"><input type="hidden" name="location_set-INITIAL_FORMS" value="0" id="id_location_set-INITIAL_FORMS"><input type="hidden" name="location_set-MIN_NUM_FORMS" value="0" id="id_location_set-MIN_NUM_FORMS"><input type="hidden" name="location_set-MAX_NUM_FORMS" value="1" id="id_location_set-MAX_NUM_FORMS">
            ...
            <input type="text" name="address" maxlength="120" class="form-control pac-target-input" placeholder="E.g 28 Saint John Street Gowon Estate Ipaja" required="true" data-parsley-group="default" id="id_location_set-0-address" data-parsley-id="2818" autocomplete="off"><span class="help-block" id="parsley-id-2818"></span>
			<br>
            <div class="form-inline row-space-top-1">
            <div class="form-group">
                <div><label>Town or City</label></div>
                <input type="text" name="vicinity" maxlength="80" class="form-control" placeholder="E.g. Ipaja" required="true" data-parsley-group="defalut" id="id_location_set-0-vicinity" data-parsley-id="1505">
...
<div class="panel panel-default row-space-4" id="credential-section">
                ...
                <div id="education-form">
                    ...
                    <div id="education_set-0-row" class="form-base dynamic-form">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="school" maxlength="125" class="form-control" id="id_education_set-0-school" data-parsley-id="7880">
                        ...
                        <div class="row row-space-2">
                            <div class="col-sm-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="course" maxlength="125" class="form-control" id="id_education_set-0-course" data-parsley-id="8037">
                         ...
                         <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <select name="degree" class="form-control" id="id_education_set-0-degree" data-parsley-id="7982">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="workexperience" maxlength="125" class="form-control" id="id_workexperience_set-0-name" data-parsley-id="6337">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="role" maxlength="125" class="form-control" id="id_workexperience_set-0-role" data-parsley-id="5587">
  ...
  <option value="" selected="">Just starting out</option>
 ...
 Montessori</label>
                ...
                <div id="curriculum_pref" class="row row-space-4  hidden ">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <textarea name="curriculum_explanation" cols="40" rows="4" maxlength="300" class="form-control" id="id_curriculum_explanation" data-parsley-id="2740"></textarea>
                        </div>
                    </div>
                </div>
        </div>
...
<div class="row row-space-4">
    ...
    <div class="col-md-9 col-sm-12 form-group ">
        ...
        <div class="well bg-info padding-bottom-30">
		   ...
		   <br>
        <textarea name="tutor_description" cols="40" rows="8" class="form-control" data-parsley-group="default" data-parsley-trigger="keyup" required="" id="id_tutor_description" data-parsley-id="1737"></textarea>
                ...
                <div class="col-sm-15 col-sm-offset-12" align="right">
					  <input type="submit" name="submitupdate"  class="btn btn-primary btn-lg" value="Submit Profile">
