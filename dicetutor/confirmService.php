      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
              <input type="text" name="searching" placeholder="Tutor Name" >
                <input type="submit" name="searchRequest1" value="Search">
              </div>
            </div>
          </form>
              <li class="nav-item">
                <a href="confirmService1.php" class="nav-link active">
                  <p>Confirm Service</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Confirm Service</h1>
			<br>
...
if (isset($_POST['searchRequest1']))
   {   
		$searching =$_POST['searching'];
 
// Attempt select query execution
$sql = "SELECT * FROM attendancedaily WHERE tutorname = '".$searching."'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:65px; width:1470px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
                echo "<th>TutorName</th>";
                echo "<th>Service Delivered </th>";
                echo "<th>Date</th>";
				echo "<th>Confirmed Service</th>";
