  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Guarantor Table</h1>
			<br>
           ...
           echo "<tr>";
            ...
            while($row = mysqli_fetch_array($result)){
			  ...
			  echo "<tr>";
                ...
                echo "<td>" . $row['ggender'] . "</td>";
	            echo "<td>" . $row['gaddress'] . "</td>";
                echo "<td>" . $row['grelationship'] . "</td>";
						
	
	
	echo  "<form action='showresult2.php' method='POST'>";	
	echo  "<input type='hidden' name='q' value='$id'>";
echo "<td><img height='60' width='73' src='picture/".$row['image']."'><br></td>";
	echo  '</form>';
