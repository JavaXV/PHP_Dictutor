...
<?php // include_once("addattendance.php");?>
 ...
 <center>      
	...
	<div class="form-group"  >
      ...
      <div class="form-group"  >
		  ...
		  <button type="submit" name="Xchange" class="btn btn-outline-info" style="right:20px; height:100px; top:110px; position:absolute;">Confirm Service</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
