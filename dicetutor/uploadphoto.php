										...
										if(mysqli_num_rows($result) > 0){
											 echo "<table>";
											   echo "<tr>"; 
												...
												echo "<tr>";
												echo "<td><img height='260' width='257' src='picture/".$row['image']."'></td>";
												echo "</tr>";
                                                    ...
                                                    <input type="file" name="file" value="" required="">
													 <input type="hidden" class="form-control" value="<?php
														   ...
														   <div class="col-sm-12 col-sm-offset-16" align="right">
																<button type="submit" name="imageUpload" style="width:260px;" class="btn btn-outline-info">Upload Photo</button> 
