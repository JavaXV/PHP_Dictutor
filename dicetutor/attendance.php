...
<?php  //include_once("attendanceview.php");?>
...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="row" >
        ...
        <form  action="attendanceview.php"  method="POST" >
          ...
          <div class="panel-body"  align="center">
                       ...
                       <br><br><br>
					<hr> <b style="color:#0000FF;">Attendance</b><hr> 
    <div class="row row-space-4"  align="center">
       ...
       <input type="text" name="code" required maxlength="140"  style="height:60px; width:600px;" value="<?php echo $code; ?>" class="form-control" size="30" placeholder="Enter Full-Name">
           <br>
        </div>
    </div>
    <div class="row  row-space-4">
        ...
        <div class="col-md-6 col-sm-6 space-for-mobile">
              <b style="position:absolute; left:5px;">  <input type="text" name="timing" required maxlength="40" class="form-control" size="130" placeholder="09:00AM" style="width:270px; height:60px; width:280px;"><h4 style="top:8px; left:280px; position:absolute;">To</h4></b><b style="position:absolute; top:2px;left:310px; width:297px;"><input type="text" style="height:60px; width:300px;" name="timing1" required maxlength="40" class="form-control" size="130" placeholder="11:00AM" ></b>
          
           
        </div>
	</div>
         
		  <button type="submit" name="AddClass" class="btn btn-outline-info" style="right:100px; height:100px; top:120px; position:absolute;">Add Attendance</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
