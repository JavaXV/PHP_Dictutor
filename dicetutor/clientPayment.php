		  ...
		  <?php
		   ...
		   ?>
		   	   ...
		   	   <?php
					...
					$sql = "SELECT id, radNo, salary, monthly, clientemail, clientname FROM serviceadd WHERE radNo = '$tutorid' ";
            ...
            ?>
					...
					if (!$conn) {
					  ...
					  if(isset($_SESSION['tutorid']) && isset($_SESSION['email']))
		              {
					...
					$sql = "SELECT id, radNo, reference, amount, email FROM transaction WHERE radNo = '$tutorid' ";
					$result = mysqli_query($conn, $sql);
  ...
  <div class="content-wrapper">
	...
	<div class="container" style="position:absolute; top:150px;">
		<div class="row">
				...
				<div class="block">
					...
					<div class="image align-self-center" style="padding-left:10px;">
						...
						<div class="col-md-10 print-table" style="position:absolute; top:20px;">
                              <p style="position:absolute; top:70px; color:#0000CC; font-size:21px; font-family:Geneva, Arial, Helvetica, sans-serif;">Payment Details</p>
							<table class="table table-striped table-hover" border="" style="width:500px; color:#0000FF; top:100px; position:absolute;">
								...
								<tbody>
									...
									<td ><p style="color:#0000FF; font-size:30px; font-family:Geneva, Arial, Helvetica, sans-serif;"><?php echo $salary."NGN" ; ?></p></td>
									...
									<td><p style="color:#0000FF; font-size:30px; font-family:Geneva, Arial, Helvetica, sans-serif;"><?php echo $monthly."NGN"  ; ?></p></td>
		   ...
		   ?>" required maxlength="40" id="email-address" class="form-control" size="130" placeholder=""  >
						  </div>
						  
						  <div class="form-group">
						  <input type="text"  required maxlength="40" value="<?php echo $amount; ?>" id="amount" class="form-control" size="130" placeholder=" Amount E.g : 120000"  >
						  </div>
						  
						 
						  <div class="form-submit">
							<!-- Submit Button -->			
						   <button type="submit" onClick="payWithPaystack()" class="btn btn-outline-info" style="width:190px; height:60px;">Complete-Payment</button>
						  </div>
						</form>
...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    key: 'pk_test_0a09507fe7cc7eb8ee0ece1e173cc24e3c90b160', // Replace with your public key
    ...
    callback: function(response){
      ...
      alert(message);	  
	  window.location = "http://localhost/dicetutor/DashboardParent.php?reference=" + response.reference;
