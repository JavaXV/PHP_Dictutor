<?php //include_once("search.php");?>
     ...
     if(isset($_POST['search'])){
      ...
      $track=$_POST['q'];
      $sql = ("SELECT * FROM serviceadd WHERE id LIKE '$track%'");
...
<br>
							...
							<table class="table table-bordered table-striped table-hover" style="width:1200px; position:absolute;">
								...
								<tbody>
									...
									<tr>
										...
										<td><p><?php echo $clientaddress ; ?></p></td>

									</tr>

									<tr>

										<td><p>CLIENT PHONENO</p></td>

										<td><p><?php echo $clientphoneno ; ?></p></td>

									</tr>

									<tr>

										<td><p>SUBJECT / COURSE</p></td>
									...
									<tr>
										...
										<td><p>TEACHING STATUS </p></td>

										<td><?php echo $teachingstatus ; ?></td>
									...
									<tr>
										...
										<td><p>SELECTED DAYS IN WEEKS</p></td>

										<td><p><?php echo $daysinweek ; ?></p></td>

									</tr>
									<tr>

										<td><p>MONTHS/WKS DURATION</p></td>

										<td><p><?php echo $duration . "  T0  " . $duration2 ; ?></p></td>

									</tr>
                                    <tr>

										<td><p>DATE.TIME OF REQUEST</p></td>

										<td><p><?php echo $dateenter ; ?></p></td>

									</tr>
									 <tr>

										<td><p>TIME.OF.DELIVERY</p></td>
										
										<td><p><?php echo $timing . "   TO   " . $timing1 ; ?></p></td>


									</tr>
									  <tr>

										<td><p>SERVICE OPTION</p></td>

										<td><p><?php echo $serviceoption ; ?></p></td>
     ...
     if (mysqli_num_rows($result) > 0) {
         ...
         while($row = mysqli_fetch_assoc($result)) {
			   ...
			   echo "<a href='serviceRequest.php' align='center'>". 'BACK' . "</a>";
