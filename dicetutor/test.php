	...
	if(isset($_POST['Xchange']))
		{
					...
					//------------------------update attendance---------------------------
						...
						$query=("UPDATE attendance SET salary='".$Payment."',interest='".$Percentage."',attendanceconfirmed='".$attendance."',timeofconfirmation='".$date."',date='".$today."' WHERE tutorname='".$tutorname."' ");
						$result = mysqli_query($conn,$query);
						  if($result)
							  {
								header("Location: confirm7Message.php");
							  }
							  else
							  {
