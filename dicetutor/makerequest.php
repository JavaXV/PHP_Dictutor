       ...
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" style="position:fixed;">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="requesting.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Requesting</p>
                </a>
              </li>
			   <li class="nav-item">
                <a href="checkRequest.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Check Request Accepted</p>
                </a>
              </li>
            </ul>
			</li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Request Table</h1>
			<br>
		    <b style="color:#0033FF;">Note: Please take note of Tutor Email Address.</b>
          </div><!-- /.col -->
          ...
          <div class="col-sm-6">
		   ...
		   if(isset($_SESSION['name']))
		   {
		     echo $_SESSION['name']. "[School/Parent]";
		   }
...
$sql = "SELECT * FROM serviceadd";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:70px; width:1280px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
