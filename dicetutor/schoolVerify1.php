...
?>
 ...
 <center>      
    ...
    <div class="row row-space-4"  align="center">
        ...
        <input type="text" name="name" maxlength="140" style="height:45px;" value=" <?php echo $firstname ." ". $lastname ; ?>" class="form-control" size="30" placeholder="Enter Name"  required="" >
		   <br>
        </div>
    </div>
    ...
    <div class="row  row-space-4">
        ...
        <div class="col-md-6 col-sm-6 space-for-mobile">
            <input type="text" name="nin" maxlength="40" class="form-control" size="130" style="height:45px;" placeholder="NIN e.g 09099998871" required="" >
           <br>
        </div>
    </div>
	<div class="row  row-space-4">
        ...
        <div class="col-md-6 col-sm-6 space-for-mobile">
            <select class="form-control"  name="idcards" style="height:45px;">
	 ...
	 <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">Upload NIN</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">    
           <b> <input type="file" name="file" style="background-color:#999999;">
        </div>
    </div>
	 <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">Upload Others</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">    
           <b> <input type="file" name="file2" style="background-color:#999999;">
        </div>
    </div>
	
	</div></div>
	
		  <button type="submit" name="subber" class="btn btn-outline-info" style="left:1310px; height:100px; top:120px; position:absolute;">Submit</button>
		  <br><br><br><br><br>
	</form>
