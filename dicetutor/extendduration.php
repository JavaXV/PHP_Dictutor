...
?>
      ...
      <div class="form-inline">
		...
		<li class="nav-item">
                <a href="attendancesubmit.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Extend Contract</h1>
			<b style="color:#0000CC; font-family:'Times New Roman', Times, serif; font-size:19px; position:absolute;">Note: If the Contract duration has expired or ended! do try and extend the service or contract and proceed to make payment</b>
    ...
    <div class="row" >
        ...
        <form  action=""  method="POST" >
          ...
          <div class="panel-body"  align="center">
                       ...
                       <br><br><br>
					<hr> <b style="color:#0000FF;">Extending Duration</b><hr> 
    <div class="row row-space-4"  align="center">
        <!-- Label -->
        <label class="col-md-3 col-sm-3 text-right">Tutor PhoneNo</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">
       <input type="text" name="phoneno" required maxlength="140"  style="height:50px; width:600px;" value="" class="form-control" size="30" placeholder="Enter Tutor PhoneNo">
           <br>
        </div>
    </div>
    ...
    <div class="row  row-space-4">
        <label class="col-md-3 col-sm-3 text-right">Period Of Duration</label>

        <div class="col-md-6 col-sm-6 space-for-mobile">
              <b style="position:absolute; left:5px;">  <input type="date" name="duration1" required maxlength="40" class="form-control" size="130" placeholder="09:00AM" style="width:270px; height:50px; width:280px;"><h4 style="top:8px; left:280px; position:absolute;">To</h4></b><b style="position:absolute; top:2px;left:310px; width:297px;"><input type="date" style="height:50px; width:300px;" name="duration2" required maxlength="40" class="form-control" size="130" placeholder="11:00AM" ></b>
          
           
        </div>
	</div>
	
		  <button type="submit" name="AddClass" class="btn btn-outline-info" style="right:100px; height:100px; top:120px; position:absolute;">Extend Duration</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
