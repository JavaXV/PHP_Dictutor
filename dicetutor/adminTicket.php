...
<?php  include_once("unpendservicescript1.php");?>
    ...
    <div class="row" >
        ...
        <form  action=""  method="POST" >
          ...
          <div class="panel-body"  align="center">
                       ...
                       <br><br><br>
					<hr> <b style="color:#0000FF;">Close or Open Ticket</b><hr> 
    <div class="row row-space-4"  align="center">
        <!-- Label -->
        <label class="col-md-3 col-sm-3 text-right">Ticket Status</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">
                                    <select class="custom-select border-0 px-4" name="tickets" style="height:60px; width:600px;"">
	 ...
	 <div class="row row-space-4"  align="center">
        <!-- Label -->
        <label class="col-md-3 col-sm-3 text-right">Ticket Close/Open</label>
        <div class="col-md-6 col-sm-6 space-for-mobile">
  	    <select class="custom-select border-0 px-4" name="close" style="height:60px; width:600px;"">
		  ...
		  <button type="submit" name="openclose" class="btn btn-outline-info" style="right:100px; height:100px; top:120px; position:absolute;">Open Or Close</button>
		  <br><br><br>
    </div>
	</div></div>
	</form>
