		 ...
		 <?php
            ...
            ?> </a>
			 ...
			 <?php
					...
					$sql = "SELECT id, code, tutoremail, clientemail FROM serviceadd WHERE tutoremail = '$email' ";
					$result = mysqli_query($conn, $sql);
       ...
       <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="" method="POST">
            <div>
              <input type="text" name="search" value="<?php echo $codeclient; ?>" class="form-control" placeholder="Unique ID" >
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
           <div class="col-sm-6">
            <h1 class="m-0">Request Confirmation...</h1>
			<br>
...
// Attempt select query execution
$sql = "SELECT * FROM serviceadd WHERE code = '".$search."'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1280px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
				...
				echo "<th>View.More.Details</th>";
				echo "<th>Decline.Request</th>";
        ...
        while($row = mysqli_fetch_array($result)){
			...
			echo "<tr>";
				...
				echo "<td>" . $row['requestmake'] . "</td>";  
				echo "<td>" . $row['requestaccept'] . "</td>"; 
                
				echo  "<form action='showView.php' method='POST'>";
				echo  "<input type='hidden' name='q' value='$id'>";
                echo  "<td>" . "<input type='submit' name='search' value='View.Details' style='color:blue;'>" . "</td>";
				echo  "</form>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='No' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submitting' value='DeclineRequest' style='color:blue;'>" . "</td>";
				echo  "</form>";
				echo  "<form action='' method='POST'>";
				echo  "<input type='hidden' name='radNo' value='$id'>";
                echo  "<td>" . "<input type='submit' name='submited' value='AcceptRequest' style='color:blue;'>" . "</td>";
				echo  "</form>";
