...
<body class="hold-transition sidebar-mini layout-fixed" style="background-color:#F8F8F8;">
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <div class="form-inline">
        ...
        <div class="input-group">
          ...
          <span class="input-group-btn" style="background-color:#0099FF;">
			  <input type="submit" name="search" value="" class="btn btn-flat" ><i class="fa fa-search"></i>
              </button>
            </span>
        </div>
      </form>
