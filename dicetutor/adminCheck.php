    ...
    <!-- Sidebar -->
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search">
           <form action="admincheck1.php" method="POST">
            <div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Find Out About Tutor For Approval...</h1>
			<br><br>
...
if (isset($_POST['submitd']))
   {   		
			...
			$query=("UPDATE editprofile SET AdminApprove='".$Approved."' WHERE id='".$id."' ");
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1250px;  height:50px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
				 ...
				 echo "<th>Degree</th>";
				 echo "<th>Status</th>";
				 echo "<th>View.ID.Card</th>";
				 echo "<th>View.Guarantor</th>";
				 echo "<th>Approved</th>";
				  echo "<th>Not.Approved</th>";
				 echo "<th>More.Detail</th>";
	    ...
	    echo  "<form action='showresult4.php' method='POST'>";
		echo  "<input type='hidden' name='id' value='$id'>";
        echo "<td><button name='searches' class='form-group' align='center' style='background-color:blue; color:white;'>Id-Card</button></td>";
    	echo  "</form>";
		
		echo  "<form action='showresult5.php' method='POST'>";
		echo  "<input type='hidden' name='code' value='$code'>";
        echo "<td><button name='searchess1' class='form-group' align='center' style='background-color:blue; color:white;'>Guarantor</button></td>";
    	echo  "</form>";
		
		echo  "<form action='' method='POST'>";
		echo  "<input type='hidden' name='id' value='$id'>";
        echo "<td><button name='submit' class='form-group' align='center' style='background-color:blue; color:white;'>Approved</button></td>";
    	echo  "</form>";
		
		echo  "<form action='' method='POST'>";
		echo  "<input type='hidden' name='id' value='$id'>";
        echo "<td><button name='submitd' class='form-group' align='center' style='background-color:blue; color:white;'>Declined</button></td>";
    	echo  "</form>";
	
	
	echo  "<form action='showresult2.php' method='POST'>";	
...
echo "<td><img height='60' width='73' src='picture/".$row['image']."'><br><button name='search'  class='form-group'  align='center' style='background-color:blue; color:white;'>About Me</button></td>";
	echo  '</form>';
        ...
        echo "<b style='font-size:40px; left:300px; position:absolute; color:blue;'>"."No records matching your request were found." . '<a href="checkRequest.php" style="font-size:20px; color:red;">Search-back</a>'."</b>";
    }
} else{
