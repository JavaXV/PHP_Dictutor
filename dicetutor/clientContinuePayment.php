  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Check To Make Payment Ahead...</h1>
			<br>
...
// Attempt select query execution
$sql = "SELECT * FROM serviceadd WHERE clientemail = '".$search."'";
//$sql = "SELECT id, radNo, salary, salary1, monthly, clientemail, clientname, balance FROM serviceadd WHERE clientemail = '".$search."'";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
         echo "<table style='position:absolute; color:black; left:250px; width:1270px;  height:50px;' class='table table-striped table-hover' border='1' ";
           echo "<tr>";
             
               
				 echo "<th>Tutor ID</th>";
				 echo "<th>Full.Payment / All Month</th>";
				 echo "<th>Remaining.Balance To Be Paid</th>";
				 echo "<th>Monthly.Payment</th>";
				 echo "<th>Payment.Duration</th>";
		    ...
		    echo "<td>" . $row['duration'] ."<br>"."To". "<br>". $row['duration2']. "</td>";
...
echo "<td><button name='search' class='form-group' align='center' style='background-color:blue; color:white;'>Payment</button></td>";
	...
	echo  "<form action='showresults.php' method='POST'>";	
	echo  "<input type='hidden' name='q' value='$id'>";
	echo "<td style='color:white;'><img height='60' width='73' src='picture/".$row['image']."' alt ='UPLOAD'</td>" . "<br>". "<button name='search'  class='form-group'  align='center' style='background-color:blue; color:white;'>Find Out</button>";
